        ...
        <section className={styles.retirementLayout}>
          ...
          <div className={styles.formGrid}>
            <div>
              ...
              <input
                ...
                onChange={(event) => setProfileField("monthlyExpenses", toNumber(event.target.value))}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(event) => setAssumptionField("inflationRate", toNumber(event.target.value))}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(event) => setAssumptionField("lifeExpectancy", toNumber(event.target.value))}
              />
            </div>
          </div>
          ...
          <div className={styles.resultTopRow}>
            <article className={styles.resultCard}>
              ...
              <div className={styles.resultValue}>{formatCurrency(computed.retirement.monthlyNeedAtRetirement)}</div>
            ...
            <article className={styles.resultCard}>
              ...
              <div className={styles.resultValue}>{formatCurrency(computed.retirement.corpusNeeded)}</div>
              <button className={styles.workingBtn}>See working ▸</button>
            </article>

            <article className={styles.resultCard}>
              <div className={styles.resultLabel}>Retirement Period</div>
              <div className={styles.resultValue}>{computed.retirement.retirementPeriodYears} yrs</div>
            </article>
          </div>
          ...
          <div className={styles.savingsBand}>
            ...
            <div className={styles.savingsBandValue}>
              {monthlySavingsRequired > 0 ? formatCurrency(monthlySavingsRequired) : "Enter your details above"}
            </div>
          </div>
